...
- Ein DNS-Eintrag für `argo-ha.hauptmann.dev`, der auf den Ingress-Controller zeigt.
...
Nach der Installation ist das ArgoCD-Dashboard unter `https://argo-ha.hauptmann.dev` verfügbar. Stelle sicher, dass der DNS-Eintrag korrekt ist.
